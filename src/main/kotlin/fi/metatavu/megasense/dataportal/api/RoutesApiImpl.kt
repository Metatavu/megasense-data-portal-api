...
class RoutesApiImpl: RoutesApi, AbstractApi() {
    ...
    override fun createRoute(route: Route): Response {
        return createOk(routeTranslator.translate(routeController.createRoute(route.routePoints, loggerUserId!!)))
    }
    ...
    override fun listRoutes(): Response {
        return createOk(routeTranslator.translate(routeController.listRoutes()))
    }
}