...
ADD --chown=jboss ./docker-resources/kubernetes-jgroups.cli /opt/docker/kubernetes-jgroups.cli
...
RUN /opt/jboss/wildfly/bin/jboss-cli.sh --file=/opt/docker/kubernetes-jgroups.cli
